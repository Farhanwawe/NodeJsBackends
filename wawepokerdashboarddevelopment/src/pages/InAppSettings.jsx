...
const PopupSettings = () => {
    ...
    useEffect(() => {
        const fetchEvent = async () => {
            try {
                ...
                const response = await axios.get(secretKey + `/admin/getInapp/${decryptedId}`);
                ...
                setEvent({
                    ...
                    lastChips: data.lastChips,
                    chips: data.chips,
                    spinner: data.spinner,
                    relatedFreeProductId: data.relatedFreeProductId
                });
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const decryptedId = decryptUserId(id);
            await axios.put(secretKey + `/admin/updateInapp/${decryptedId}`, dataToSend);
